package com.example.demo.batch.job.reader;

import com.example.demo.batch.domain.pay.Pay;
...
import static com.example.demo.batch.job.reader.PaymentCursorJobConfiguration.JOB_NAME;
